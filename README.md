...
- [`App/Containers`](App/Containers): container components, i.e. the application's screens logic
- [`App/Screens`](App/Screens): Screens components, i.e. the application's screens
