...
import {
  SIZE_MATTERS_DEFAULT_SCALE_FACTOR,
...
const screen = {
  ...
  virtualBar: Platform.OS === 'ios' ? false : dimensionsHeight !== Dimensions.get('screen').height,
  ...
  size: Dimensions.get('window').width * Dimensions.get('window').scale > 1080 ? 'L' : 'S',
  // verticalScale,
  // moderateScale,
  // screenSize:
  isX,
